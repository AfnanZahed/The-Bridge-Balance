...
> Student-oriented platform for spec-driven AI agent engineering. 4 stages. 2 Harvard certificates. 100% free.
...
Every component runs on a free tier until usage justifies a paid tier. See [`edu-site/docs/llm-providers.md`](./edu-site/docs/llm-providers.md) and [ADR-0001](./history/adr/0001-free-tier-llm-choice.md).
...
TBD — see [`edu-site/LICENCE`](./edu-site/LICENCE) when added.
