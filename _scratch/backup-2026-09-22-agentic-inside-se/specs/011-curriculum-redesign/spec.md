...
**Status:** in progress (slice 1 of the redesign).
...
1. **The audience of the material that moved.** Old Stage 3 (AI coding agents) is parked on audience; it now sits inside new Stage 1, which is beginner-first. Recorded as CS-Q7 in `course-structure.md`.
