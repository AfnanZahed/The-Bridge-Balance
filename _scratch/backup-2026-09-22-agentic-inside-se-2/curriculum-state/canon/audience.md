...
**In Stages 0–2, a hard word or a named person must earn its place. If the idea works without it, leave it out.** → Live rule: `.claude/skills/lesson-spine-authoring/reference/mixed-audience.md` "1. Why a beginner stops reading". Moved 2026-09-21 under ADR-0007.
