...
**What stays the same.** Stages 0 to 2 still assume a reader who has never programmed (`audience.md`, `corrections.md` §8). Stages 3 and 4 stay parked, as the owner decided on 20 September. This file does not reopen them. *(22 September 2026: the numbering changed — there is no Stage 3 or 4 now; see section 5. The floor's own wording is CS-Q7 in section 6.)*
