...
Voice style field ("Describe the voice style"):

```
A warm, confident narrator introducing something they truly believe in. Sincere and conversational, like a respected teacher speaking to one person, with a gentle smile in the voice. Clear and credible, never pushy.
...
A free online book that takes you from zero to leading AI agents, with engineering judgment.

AI now writes code in seconds. So students everywhere are asking: is learning to code still worth it?
It is. But not the way it has always been taught.

Some people refuse to use AI, and fall behind. Others trust whatever it writes, and pay for it later.
One 2025 study found that experienced developers took 19% longer on real tasks when using AI tools, and still believed AI had made them faster.

The Bridge Balance takes a third road. We teach you to use the most powerful AI coding agents, like Claude Code, Codex, Cursor and OpenCode, and to judge everything they build. That is our specialty.
...
The method is Spec-Driven Engineering. You write a spec, an exact description of what to build. An AI agent builds it. Then you judge the result, so you know whether it's right, instead of hoping it is.

There are three stages. Stage Zero: the foundations, and your first practical steps. Stage One: real software, built with AI agents. Stage Two: advanced engineering, and advanced AI agents of your own.
Most courses teach the basics first and leave AI for the end. Here, you learn both side by side: the same chapter teaches you how software really works, and how to lead the AI agents that build it.

You don't need a technical background. Whether you're a student, a doctor, a teacher or a business owner, we respect the experience you bring. And we built this for someone who has never written a line of code. You'll learn in simple English, and every new term is explained the moment you meet it.

Behind it are nearly three months of research and planning, and more than five weeks of building. We studied books, documentaries and talks, and the work of leaders in tech and education, like Andrew Ng, David Malan and Irfan Malik. We kept the best of each, and went further.

More than 2.4 billion AI tokens, the units AI companies charge for, went into researching and building this platform. That costs real money. We carry that cost so you don't have to: the content is 100% free, forever.

Now, where are we today? The Bridge Balance is in Alpha, its earliest public version. For now, it lives at this temporary address. Stage Zero is being rewritten from scratch right now, and the early pages you see today will be replaced.
Next comes Beta, with the first new chapters ready to read.
Then the book moves to its permanent home, most likely thebridgebalance.com. Got a better web address in mind? Tell us in the comments.
...
## Open decisions (answer these before recording)
...
| Voice starts at | Screen |
|---|---|
| "Introducing…" | Homepage hero with the logo. Hold for 2 s, then open `/welcome` |
| "AI now writes code…" | § Why this book exists, and the two habits it replaces. At "One 2025 study", zoom on the METR sentence |
| "The Bridge Balance takes a third road" | § How this book treats AI, and what it specialises in |
| "At its heart…" | § Code Literacy: reading and judging code… |
| "The method is…" | § What Spec-Driven Engineering is, in plain words |
| "There are three stages" | § The three stages… Zoom on each table row as its stage is named |
| "You don't need…" | § What you need to start, and what you don't (the table) |
| "Behind it are…" | § How this book was built, and what it cost. While the names are said, zoom on "none of them is affiliated…" |
...
- **19% longer, yet believed faster.** METR, July 2025: 16 experienced open-source developers, 246 real tasks. The Welcome page states the same finding (`welcome.md:32`).
- **Nearly three months / more than five weeks.** Research since 29 June 2026 and development since 19 August 2026 (`job24b-video-facts.md` §2). If the video goes out after 29 September, say "three months".
...
If AI Studio says "Andrew N-G", type "Andrew Ing". If it stumbles on the domain, type "the bridge balance dot com". Listen to "Irfan": it should sound like "Ir-faan", and a Pakistani audience will notice if it doesn't.
