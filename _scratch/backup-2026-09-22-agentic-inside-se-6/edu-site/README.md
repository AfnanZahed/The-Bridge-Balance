...
│   ├── intro-1-binary-to-programming.md       # intro sequence (placeholder)
...
│   ├── stage-02-credentials/                  # the Credentials track (not a stage; disabled)
│   └── stage-03-sde-mastery-ai-native/        # Stage 2 — SDE Mastery (AI-Native); pending renumber
├── src/
