 ...
 *   2. Stages grid — 4 stage cards with muted Apple-grade accent chips
...
// a hue: the four plates descend the silver ramp exactly as the four stages do,
...
export default function Home(): React.ReactElement {
  return (
    <Layout
      ...
      description="A 4-stage curriculum with 2 Harvard certificates, teaching students to lead AI coding agents with engineering judgment. 100% free."
    >
      <Head>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "A free, four-stage curriculum teaching spec-driven AI agent engineering, from computing fundamentals through autonomous multi-agent systems, anchored by two Harvard CS50 certificates.",
            ...
            <RevealOnScroll as="div">
              <div className="tbb-section-heading">
                ...
                <h2 className="tbb-section-heading__title">
                  Four stages, one bridge from student to engineer.
                </h2>
