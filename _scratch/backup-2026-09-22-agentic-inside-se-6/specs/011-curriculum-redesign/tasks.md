...
| T018 | Minimal fact fixes on the reader pages the inventory lists | Claude writes, DeepSeek applies | pending, after T017 | the inventory's category E hits; the repository root `README.md` ("5 stages", "Stages 0–4" and its status table) |
