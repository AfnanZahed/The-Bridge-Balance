...
> "The reader", and recorded in `curriculum-state/canon/corrections.md`, "8.
> Stages 0–2 are written for absolute beginners, and for nobody else". Open both
> before writing for any stage.
>
...
the sentence"; the engineering phrases of the Stages 3–4 safety wording are
...
| **Stages 3, 4** | **Soft** | The first three stages, plus what the reader has learned since. The same reader, further along; how these stages are written waits for the redesign. Do not assume a separate expert. |
...
**Chapter:** *What an AI coding agent actually is.* Shape: Concept. Stage 3, so
