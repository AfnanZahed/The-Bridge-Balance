...
curriculum sets four stages; it does not fix how many chapters each stage
...
│   ├── thesis.md            Thesis, four stages, two extremes, safety floor.
...
Seeded 2026-08-23 from `edu-site/docs/intro.md`, the only text-ready chapter.
