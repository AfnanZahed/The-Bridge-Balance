> **Promoted 2026-09-20.** Three decisions recorded in this file were binding on
> nothing, because this folder is read by no skill. They are now in
> `curriculum-state/canon/`:
>
> - the **light historical register** for Stage 0 → `canon/corrections.md` §4
> - **beginner-only**, now extended to Stages 0, 1 and 2 → `canon/audience.md`
>   and `corrections.md` §8
> - **"whole must be done from scratch — content, voice, tone, wording"** → the
>   new voice in `canon/voice.md`, which this record asked for on 16 September
>   and which was never actually written until now. That gap is why `ch01`
>   shipped in the voice the owner had already asked to replace.
>
> Line 77's *"every chapter is read by a senior engineer and a complete beginner"*
> is **withdrawn** — see `corrections.md` §8.
