...
const sidebars: SidebarsConfig = {
  mainSidebar: [
    ...
    {
      type: "category",
      label: "Stage 2 — SDE Mastery (AI-Native)",
      collapsed: true,
      customProps: { stage: 2 },
      link: { type: "doc", id: "stage-02-sde-mastery-ai-native/index" },
      items: [
        "stage-02-sde-mastery-ai-native/rag-and-tool-calling",
        "stage-02-sde-mastery-ai-native/multi-agent-systems",
        "stage-02-sde-mastery-ai-native/evaluations",
      ],
    },
    {
      type: "category",
