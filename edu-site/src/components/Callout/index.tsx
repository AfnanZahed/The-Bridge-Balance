/**
 * <Callout /> — admonition box for MDX, keyed to the monochrome silver ramp
 * (not hue) except where noted.
 *
 * Variants:
 *   - info      (neutral ink)
 *   - tip       (stage-1)
 *   - important (stage-2)
 *   - warning   (stage-3)
 *   - danger    (red — the deliberate chromatic exception, see custom.css)
 *
 * Usage in MDX:
 *
