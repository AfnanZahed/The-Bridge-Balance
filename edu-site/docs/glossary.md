...
sidebar_position: 98
title: "Glossary"
description: "Every term this book has defined so far, with the one canonical wording each chapter reuses verbatim."
---
...
*First defined in [Introduction](/intro), Beginner · Summary.* An everyday-language version of the same idea also appears in Beginner · Balanced: *a very fast, very capable helper — not an architect, and not the owner of the result.*

### Blast radius

How much can break, and how far the damage reaches, if a change goes wrong.

*First defined in [Introduction](/intro), Advanced · Detailed (Surface 2 — Tool calling).*

### Specification (spec)

A written statement of what you want built and what shouldn't change, agreed before you start.

*First defined in [Introduction](/intro), Beginner · Summary.*
...
*First defined in [Introduction](/intro) (all cells — this is the book's thesis). Curriculum-coined; must be defined on first use in every cell that relies on it, including Advanced cells, because this is this project's own vocabulary rather than field-standard terminology.*
...
*First defined in [Introduction](/intro), Beginner · Balanced. Always attributed — never presented as this curriculum's own coinage.*
